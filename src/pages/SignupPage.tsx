        ...
        <BackgroundPaths>
          <div className="flex items-center justify-center min-h-[80vh] px-4">
            ...
            >
              ...
              <div className="glass-card rounded-2xl p-8 mb-6 backdrop-blur-md">
        ...
        <section className="pt-32 pb-24 px-4">
          <div className="container mx-auto max-w-lg">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8 space-y-5 backdrop-blur-md">
                <div>
                  <label className="font-body text-sm font-medium text-foreground mb-2 block">Full Name</label>
                  <div className="relative">
                    <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                    <Input type="text" value={form.fullName} onChange={(e) => handleChange("fullName", e.target.value)} placeholder="Your full name" className="font-body pl-10" required />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="email" value={form.email} onChange={(e) => handleChange("email", e.target.value)} placeholder="you@example.com" className="font-body pl-10" required />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="password" value={form.password} onChange={(e) => handleChange("password", e.target.value)} placeholder="••••••••" className="font-body pl-10" required minLength={6} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <KeyRound size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                    <Input type="password" value={form.confirmPassword} onChange={(e) => handleChange("confirmPassword", e.target.value)} placeholder="••••••••" className="font-body pl-10" required minLength={6} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea value={form.wellnessGoal} onChange={(e) => handleChange("wellnessGoal", e.target.value)} placeholder="What do you hope to achieve on your wellness journey?" className="font-body min-h-[80px]" required />
                </div>
                ...
                <div>
                  ...
                  <Slider value={[form.stressLevel]} onValueChange={(val) => handleChange("stressLevel", val[0])} min={1} max={10} step={1} className="w-full" />
